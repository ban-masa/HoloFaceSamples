...
namespace HoloFaceSamples
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            OnResize();
            //Set service
            //await FaceDetectorService.InitializeServiceAsync(SetMediaCapture);
            await FaceTrackerService.InitializeServiceAsync(SetMediaCapture);
        }

        private async Task SetMediaCapture(MediaCapture capture)
        {
            DummyElement.Source = capture;
